...
public class TDeleteFragment extends DialogFragment {

    private DatabaseReference firebaseDelete;
    private AppCompatEditText inputId;
    private Button button;

    public static TDeleteFragment newInstance() {
        Bundle args = new Bundle();
        TDeleteFragment fragment = new TDeleteFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_trainer_delete, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        firebaseDelete = FirebaseDatabase.getInstance().getReferenceFromUrl("https://gymdatabase-63161.firebaseio.com/TrainerDirectory");
