...
**
**     Contents  :
**         EnableInt   - void SPI_EnableInt(void);
**         DisableInt  - void SPI_DisableInt(void);
**         SetWaitMode - void SPI_SetWaitMode(void);
**         SetStopMode - void SPI_SetStopMode(void);
**
...
#define SPI_SetStopMode() \
  /*lint -save  -e950 Disable MISRA rule (1.1) checking. */\
  {__asm("ANDCC #0x7F"); __asm("STOP"); } \
  /*lint -restore Enable MISRA rule (1.1) checking. */
/*
** ===================================================================
**     Method      :  SPI_SetStopMode (component MC9S12C32_80)
**
**     Description :
...
#define SPI_SetWaitMode() \
  /*lint -save  -e950 Disable MISRA rule (1.1) checking. */\
  __asm("WAI") \
  /*lint -restore Enable MISRA rule (1.1) checking. */
/*
** ===================================================================
**     Method      :  SPI_SetWaitMode (component MC9S12C32_80)
**
**     Description :
...
#define   SPI_DisableInt()  __DI()     /* Disable interrupts */
/*
** ===================================================================
**     Method      :  SPI_DisableInt (component MC9S12C32_80)
**
**     Description :
...
#define   SPI_EnableInt()  __EI()      /* Enable interrupts */
/*
** ===================================================================
**     Method      :  SPI_EnableInt (component MC9S12C32_80)
**
**     Description :
