...
void MCU_init(void)
{
  ...
  /* WOMM: WOMM5=0,WOMM4=0,WOMM3=0,WOMM2=0 */
  WOMM &= (unsigned char)~(unsigned char)0x3CU;                     
  ...
  SPICR1 = 0x00U;                      /* Disable the SPI module and clearing flags in SPISR register */
  /* SPICR2: MODFEN=0,BIDIROE=0,SPISWAI=0,SPC0=0 */
  SPICR2 = 0x00U;                                      
  /* SPIBR: SPPR2=0,SPPR1=0,SPPR0=0,SPR2=0,SPR1=0,SPR0=0 */
  SPIBR = 0x00U;                                      
...
/*lint -restore Enable MISRA rule (1.1) checking. */
  ...
  &isrVspi,                            /* 0x13  0xFFD8   1  ivVspi        used by PE */
